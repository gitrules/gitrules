...
func (x concernPolicy) Open(
	...
	return nil, notice.Noticef(ctx, "Started managing this issue, using the Plural Management Protocol v1,  as GitRules concern `%v` with initial __priority score__ of `%0.6f`."+
